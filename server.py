...
def save_to_json(theme, genre, generated_text):
    """Save the generation data to a JSON file"""
    data_file = 'data.json'
    
    # Create the entry for this generation
    new_entry = {
...
def generate():
    try:
        ...
        # Save the generation to JSON file
        save_to_json(theme, genre, generated_text)

        # Create a response with both text and metadata
        response_data = {
